...
const profilcard = () => {
  return (
    ...
    <div className="flex flex-col items-center py-8">
      <Image src={linda} alt="Foto Profil" className="w-24 h-24 rounded-full mb-4" />
      <h1 className="text-2xl font-bold">Linda Septiana</h1>
      <p className="text-gray-600">Seorang Mahasiswa dari Stmik Jayakarta yang sedang mengerjakan tugas akhir mata kuliah lab pemrograman web</p>
      <div className="flex mt-4">
      <div className="sm:flex sm:items-center sm:justify-between">
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="https://www.instagram.com/sirup06" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://github.com/chocoo11" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://dribbble.com/lilican08" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
